...
class CreateDriver : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSaveDriver.setOnClickListener {
            createNewDriver()
            Snackbar.make(it, "${User.currentUser.name} ${getString(R.string.strCreateDriver)} ", Snackbar.LENGTH_LONG)
                .show()
        }
    }
    ...
    fun createNewDriver(){
        ...
        DriverHttpAdapter.createNewDriver(driverName,driverLastname,driverBirthDate,0,driverLicense)
